<?php
		...
		//isset()
		$serverList = isset($_POST["serverList"]) ? $_POST["serverList"] : '';
		...
		//isset()
		$formatList = isset($_POST["formatList"]) ? $_POST["formatList"] : '';
		...
		//isset()
		$servID = isset($_POST["selectedServer"]) ? $_POST["selectedServer"] : '';
		
		//isset()
		$format = isset($_POST["selectedFormat"]) ? $_POST["selectedFormat"] : '';
		...
		$selectedVideo = isset($_POST["selectedVideo"]) ? $_POST["selectedVideo"] : '';
